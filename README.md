...
Terminal-first AI assistant for short answers, local notes, and later retrieval.

The current goal is not to polish features yet. The goal is to clean the codebase enough that adding prompt modes, piped input, note saving, and retrieval works.
