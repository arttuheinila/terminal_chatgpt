...
def test_parse_notes_list_command():
    parsed = parse_user_input("notes list")

    assert parsed.type == "list_notes"

def test_parse_notes_show_command():
    parsed = parse_user_input("notes show piped-input-testing")
